...
<html>
	...
	<body>
		<div class="form_container">
			<h2>使用者資料表單</h2>
			<form class="pure-form" method="Post" action="http://localhost:8080/JavaWeb/user"> <%--全名http://localhost:8080/JavaWeb/user--%>
				<fieldset>
					...
					<input name="gender" type="radio" value="male" checked>&nbsp;女
					<p />					
					<label>年齡：</label>
