...
//		resp.setContentType("text/html;charset=UTF-8");  因為JSP本身就有編碼(HTML), 可以不寫
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 接收表單資料
		// 1.請求編碼(輸入表單是中文?英文? 英文的話不用, 因為是他們的系統(就像網址我們要寫.tw美國不用一樣, 都是他們的系統))
		...
		// 3.將參數資料注入到 Model(資料)中 (User.java)
		...
		req.setAttribute("user", user); // 將 user 資料物件傳遞給jsp
		rd.forward(req, resp);
	}
